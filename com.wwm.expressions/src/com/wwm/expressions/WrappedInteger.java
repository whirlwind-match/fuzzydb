...
public class WrappedInteger implements WrappedValue {

	private static final long serialVersionUID = 3906371506543278388L;
	private int value;
	...
	public WrappedValue add(WrappedValue rhs) {
		if (rhs instanceof WrappedInteger) {
			return new WrappedInteger(this.value + ((WrappedInteger)rhs).getValue());
		}
