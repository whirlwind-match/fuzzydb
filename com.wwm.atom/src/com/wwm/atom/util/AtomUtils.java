...
public class AtomUtils {
    ...
    static public void printWwm(Abdera abdera, Document<? extends Entry> doc) throws IOException {
    ...
    static public void prettyPrint(Document<? extends Element> doc) {
        //=== Write it prettily! ===
        Abdera abdera = AtomFactory.getAbdera();
        try {
