 ...
 * @version $Id: TIterator.java,v 1.2 2007/03/24 16:04:53 robeden Exp $
 */
abstract class TIterator {
    ...
    public void remove() {
        ...
        final float auto_compation_factor = _hash._autoCompactionFactor;
        try {
            _hash._autoCompactionFactor = 0;
            _hash.removeAt(_index);
        }
        finally {
            _hash._autoCompactionFactor = auto_compation_factor;
        }
