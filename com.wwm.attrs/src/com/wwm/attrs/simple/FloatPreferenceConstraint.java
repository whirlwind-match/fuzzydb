...
public class FloatPreferenceConstraint extends DimensionsRangeConstraint {
    ...
    /* (non-Javadoc)
     * @see com.wwm.attrs.dimensions.DimensionsRangeConstraint#getSubBoxLow(float, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wwm.attrs.dimensions.DimensionsRangeConstraint#getSubBoxHigh(float, int)
     */
    @Override
